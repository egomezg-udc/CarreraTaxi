...
use TaxiApp\Carrera\Application\CreateCarreraUseCase;

$repository = new PdoCarreraRepository($pdo);
$useCase    = new CreateCarreraUseCase($repository);
...
<head>
    ...
    <title>Registrar Carrera - CarreraTaxi</title>
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        h1 { color: #1a1a2e; margin-bottom: 1.5rem; font-size: 1.4rem; border-bottom: 3px solid #e94560; padding-bottom: 0.5rem; }
        ...
        .btn { background: #1a1a2e; color: white; padding: 0.8rem; border: none; border-radius: 6px; width: 100%; font-size: 1rem; cursor: pointer; margin-top: 1rem; transition: background 0.2s; }
    ...
    <form method="POST" action="">
        <div class="form-grid">
            ...
            <div class="form-group">
                ...
                <input type="text" id="taxi" name="taxi" required placeholder="Ej: ABC-123">
            </div>
            <div class="form-group">
                <label for="taxista">Taxista</label>
                <input type="text" id="taxista" name="taxista" required placeholder="Nombre del taxista">
            </div>
            <div class="form-group">
                <label for="cantidadPasajeros">Pasajeros (1-6)</label>
                <input type="number" id="cantidadPasajeros" name="cantidadPasajeros" min="1" max="6" value="1" required>
            </div>
            <div class="form-group">
                <label for="barrioInicio">Barrio de Inicio</label>
                <input type="text" id="barrioInicio" name="barrioInicio" required placeholder="Barrio de origen">
            </div>
            <div class="form-group">
                <label for="barrioLlegada">Barrio de Llegada</label>
                <input type="text" id="barrioLlegada" name="barrioLlegada" required placeholder="Barrio de destino">
            </div>
            <div class="form-group">
                <label for="kilometros">Kilómetros</label>
                <input type="number" id="kilometros" name="kilometros" step="0.1" min="0.1" required placeholder="Ej: 5.3">
            </div>
            <div class="form-group">
                <label for="duracionMinutos">Duración (minutos)</label>
                <input type="number" id="duracionMinutos" name="duracionMinutos" min="1" required placeholder="Ej: 15">
            </div>
            <div class="form-group full">
                <label for="precio">Precio ($)</label>
                <input type="number" id="precio" name="precio" step="0.01" min="0" required placeholder="Ej: 12500.00">
            </div>
        </div>
        <button type="submit" class="btn">Guardar Carrera</button>
    </form>
    <a href="index.php" class="link">← Ver listado de carreras</a>
</div>
</body>
</html>
